...
public class WeatherWidget implements CustosModuleWidget {
    ...
    public void updateWidget() {
        ...
        this.weatherStatusLabel.setToolTipText(new DirectI18N("Today's weather condition: ${0}", this.forecastData.getList().get(0).getWeather().get(0).getDescription()).toString());
        ...
        this.forecastIconLabel1.setToolTipText(new DirectI18N(this.forecastData.getList().get(1).getWeather().get(0).getDescription()).toString());
        this.forecastLabel1.setForeground(this.colorProvider.foregroundColor());
        this.forecastLabel1.setRightShadow(1, 1, this.colorProvider.shadowColor());
        ...
        this.forecastIconLabel2.setToolTipText(new DirectI18N(this.forecastData.getList().get(2).getWeather().get(0).getDescription()).toString());
        this.forecastLabel2.setForeground(this.colorProvider.foregroundColor());
        this.forecastLabel2.setRightShadow(1, 1, this.colorProvider.shadowColor());
        ...
        this.forecastIconLabel3.setToolTipText(new DirectI18N(this.forecastData.getList().get(3).getWeather().get(0).getDescription()).toString());
        this.forecastLabel3.setForeground(this.colorProvider.foregroundColor());
        this.forecastLabel3.setRightShadow(1, 1, this.colorProvider.shadowColor());
